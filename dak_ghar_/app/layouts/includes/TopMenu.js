    ...
    return (
        <>
            <div id="TopMenu" className="border-b">
                <div className="flex items-center justify-between w-full mx-auto max-w-[1200px] bg-sky-500/100 opacity-70">
                    <ul 
                        id="TopMenuLeft"
                        className="flex items-center text-[11px] text-[#333333] px-2 h-12"
                    >
                    ...
                    >
                        ...
                        >
                            <img width={50} src="/images/azadi_icon.svg"/>
                            Ship to
                        </li>
                        <ClientOnly>
                            <li className="px-3 hover:underline cursor-pointer">
